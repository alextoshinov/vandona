...
<div class="product-list"> <div class="products-block">
	      ...
	      <div class="image"><?php if( $product['special'] ) {   ?>
	    	...
	    	<a class="img" href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" title="<?php echo $product['name']; ?>" alt="<?php echo $product['name']; ?>" /></a>
	      	...
	      	<?php } ?>
				...
				<?php } } ?>
				<div class="pic-swap-controls">
                	<a class="pic-prev"  data-placement="top" data-toggle="tooltip" data-original-title="Предишна"><span><i class="fa fa-angle-left"></i></span></a>
			    	<a class="pic-next"  data-placement="top" data-toggle="tooltip" data-original-title="Следваща"><span><i class="fa fa-angle-right"></i></span></a>
		        </div>
	      </div>
   ...
   <a class="back-to-top" href="#">Върнете се в началото</a>

...
<section class="col-lg-<?php echo $SPAN[1];?> col-md-<?php echo $SPAN[1];?> col-sm-12 col-xs-12">
	<div id="content"><?php echo $content_top; ?>
		<div class="product-info">
			<div class="row">
        <?php if ($thumb || $images) { ?>
    <div class="col-lg-7 col-md-7 image-container">
        <?php if ($thumb) { ?>
        <div class="image">
        ...
        <div class="product-extra clearfix">
          ...
          <div class="color-wrapper">
          	...
          	<ul class="item-colors-list clearfix">
				<li><label title="бял" class="item-color white"><span>бял</span></label></li>
				<li><label title="жълт" class="item-color yellow"><span>жълт</span></label></li>
				<li><label title="оранж" class="item-color orange active"><span>оранж</span></label></li>
				<li><label title="кафяв" class="item-color brown"><span>кафяв</span></label></li>
				<li><label title="розов" class="item-color pink"><span>розов</span></label></li>
				<li><label title="лилав" class="item-color purple"><span>лилав</span></label></li>
				<li><label title="син" class="item-color blue"><span>син</span></label></li>
				<li><label title="сив" class="item-color gray"><span>сив</span></label></li>
				<li><label title="зелен" class="item-color green"><span>зелен</span></label></li>
				<li><label title="червен" class="item-color red"><span>червен</span></label></li>
				<li><label title="черен" class="item-color black"><span>черен</span></label></li>
				<li><label title="шарен" class="item-color multi"><span>шарен</span></label></li>
			</ul>
          </div>

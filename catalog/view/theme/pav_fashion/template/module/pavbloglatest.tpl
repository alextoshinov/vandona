						...
						<div class="blog-item">					
							<div class="blog-body clearfix">
								...
								<div class="group-blog">
									...
									<span class="created"><span><?php echo $blog['created'];?></span></span> | <span class="comment_count"><span><?php echo $blog['comment_count'];?> <?php echo $this->language->get("text_comment_count");?></span> </span>

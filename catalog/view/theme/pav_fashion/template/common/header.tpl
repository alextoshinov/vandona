...
<section id="header">
		<section id="topbar-mini">
			<div class="container">
				<div class="inner">
					<div class="row">
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 tb-mini-left">
							<?php echo $text_customer_care; ?>
						</div>
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 tb-mini-center">
							<?php echo $text_free_shipping; ?>
						</div>
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 tb-mini-center">
							<?php echo $text_quality_guarantee; ?>
						</div>
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 tb-mini-right">
							<?php echo $text_vaucher; ?>
						</div>
						<!-- <?php echo $language; ?> -->
					</div>
				</div>
			...
			<div class="container">
					...
					<div class="row hidden-sm hidden-xs">
						...
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
								...
								<div class="welcome hidden-sm hidden-xs med-up-right">
									<?php if (!$logged) { ?>
								...
								<div class="med-up-right pull-right">
									<?php echo $cart; ?>
								</div>	

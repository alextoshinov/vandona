<?php
$_['lang_heading_title']        = 'OpenBay Pro за eBay | Настройки';
...
$_['lang_yes']                  = 'Да';
$_['lang_update']               = 'Обнови';
$_['lang_no']                   = 'Не';
$_['lang_import']               = 'Импорт';
$_['lang_clear']                = 'Изчисти';
$_['lang_add']                  = 'Добави';
$_['lang_remove']               = 'Изтрий';
$_['lang_load']                 = 'Зареди';
$_['lang_text_success']         = 'Настройките са запазени';

$_['lang_error_save_settings']  = 'Трябва да запазите първоначалните си настройки.';

$_['lang_tab_token']            = 'API Детайли'; 
$_['lang_tab_general']          = 'Настройки'; 
$_['lang_tab_setup']            = 'Настройки'; 
$_['lang_tab_defaults']         = 'Списък по подразбиране '; 
$_['lang_tab_shipping']         = 'Доставка по подразбиране';

$_['lang_legend_api']           = 'Информация за връзката';
$_['lang_legend_app_settings']  = 'Настройки на приложенията';
$_['lang_legend_default_import']= 'Настройки по подразбиране за Импорт';
$_['lang_legend_payments']      = 'Плащания';
$_['lang_legend_returns']       = 'Върнати стоки';
$_['lang_legend_linkup']        = 'Линкове';
$_['lang_legend_usage']         = 'Използвайте обаждане';
$_['lang_legend_subscription']  = 'Абонамент';

$_['lang_error_oc_version']     = 'Вашата версия на OpenCart е <u>и не</u>поддържа';

$_['lang_status']               = 'Статус';
$_['lang_enabled']              = 'Разрешен';
$_['lang_disabled']             = 'Забранен';
$_['lang_obp_token']            = 'Директни линкове';
$_['lang_obp_token_register']   = 'Кликнете тук, за да се регистрирате ';
$_['lang_obp_token_renew']      = 'Кликнете тук, за да подновите Вашият секретен Ключ ';
$_['lang_obp_secret']           = 'Секретен Ключ';
$_['lang_obp_string1']          = 'Криптиращ ред 1';
$_['lang_obp_string2']          = 'Криптиращ ред 2';
$_['lang_app_setting_msg']      = 'Вашите настройки на приложенията ви позволяват да конфигурирате начина на работа на OpenBay Про и интегрирането му с вашата система.';
$_['lang_app_end_ebay']         = 'Пиключване продажбата на стоки?<span class="help">Ако приключите с продажбите трябва да прекратите регистрацията си в eBay?</span>';
...
$_['lang_app_logging']          = 'Активирайте Регистрацията';
$_['lang_app_currency']         = 'Основна Валута';
$_['lang_app_currency_msg']     = 'Въз основа на валутите от вашия магазин';
$_['lang_app_cust_grp']         = 'Клиентски Групи<span class="help">Когато се създават нови клиенти,показва към коя група трябва да ги добавите</span>';
